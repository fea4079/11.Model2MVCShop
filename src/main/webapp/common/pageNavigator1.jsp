	...
	<nav>
		  ...
		  <ul class="pagination" >
			...
			<c:if test="${ resultPage.currentPage > resultPage.pageUnit }">
		      ...
		      <a href="javascript:fncGetProductList('${ resultPage.currentPage-1}','${param.menu}')" aria-label="Previous">
			...
			<c:if test="${ resultPage.endUnitPage < resultPage.maxPage }">
		      ...
		      <a href="javascript:fncGetProductList('${resultPage.endUnitPage+1}','${param.menu}')" aria-label="Next">
